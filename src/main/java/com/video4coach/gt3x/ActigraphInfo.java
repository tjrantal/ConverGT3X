...
public class ActigraphInfo {
	...
	public void setBoardRevision(int boardRevision) {
		BoardRevision = boardRevision;
	}
	public int getUnexpectedResets() {
		return UnexpectedResets;
	}
	public void setUnexpectedResets(int unexpectedResets) {
